...
datapath = 'DATAPATH';  % different folder for each experiment
% opt.inputFormat = 'row';
opt.algName = 'Nicolas Griffiths and Adrien Thibault';
opt.comments = 'Final Version';
...
functions = [1 14 16 19 21];  % or benchmarksnoisy(...)
instances = [1:10, 46:50];  % 15 function instances
